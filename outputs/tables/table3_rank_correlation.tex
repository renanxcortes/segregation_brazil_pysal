\begin{table}
\caption{Kendall rank correlation (tau) between the city rankings on the nine segregation indices (city level, 2022 Census). Columns: D=Dissimilarity, SD=Spatial Dissimilarity, G=Gini, H=Entropy, Iso=Isolation, DDI=Distance-Decay Isolation, RCo=Relative Concentration, RCe=Relative Centralization, RCl=Relative Clustering.}
\label{tab:rankcorr}
