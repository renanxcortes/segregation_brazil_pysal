% Derived from ../../outputs/tables/table_summary_stats.tex (adapted for sn-jnl).
\begin{table}[h]
\caption{Descriptive statistics of the nine segregation indices (all 319 cities, 2022 Census).}\label{tab:summary}%
\small
